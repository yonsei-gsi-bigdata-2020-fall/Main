...
1. [https://github.com/yonsei-gsi-bigdata-2020-fall](https://github.com/yonsei-gsi-bigdata-2020-fall)로 이동
1. 우측에 **New** 버튼 클릭
...
여기에 작성
### 4. 본인이 평소에 관심 갖고 있던 기술에 대해서 작성해주세요 (수업과 관련된 기술 중)
여기에 작성
### 5. 만약에 본인의 프로그래밍 실력이 출중하고, 돈과 시간도 충분하다면 어떠한 프로젝트를 해보고 싶으신가요?
여기에 작성
### 6. 수업에서 특별히 바라는 점
여기에 작성
### 7. 기타 코멘트
